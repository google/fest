...
public class AbstractContainerFixture_textBox_Test extends RobotBasedTestCase {
  ...
  public void should_fail_if_visible_JTextComponent_not_found_by_name() {
    ...
    thrown.expectMessage("name='myTextField', type=javax.swing.text.JTextComponent, requireShowing=true");
  ...
  public void should_fail_if_visible_JTextComponent_not_found_by_type() {
    thrown.expect(ComponentLookupException.class);
    thrown.expectMessage("Unable to find component using matcher");
    thrown.expectMessage("type=javax.swing.text.JTextComponent, requireShowing=true");
    fixture.textBox();
  }
