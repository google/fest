...
public class AbstractContainerFixture_comboBox_Test extends RobotBasedTestCase {
  ...
  public void should_fail_if_visible_JComboBox_not_found_by_name() {
    ...
    thrown.expectMessage("name='myComboBox', type=javax.swing.JComboBox, requireShowing=true");
  ...
  public void should_fail_if_visible_JComboBox_not_found_by_type() {
    thrown.expect(ComponentLookupException.class);
    thrown.expectMessage("Unable to find component using matcher");
    thrown.expectMessage("type=javax.swing.JComboBox, requireShowing=true");
    fixture.comboBox();
  }
