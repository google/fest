...
public class AbstractContainerFixture_checkBox_Test extends RobotBasedTestCase {
  ...
  public void should_fail_if_visible_JCheckBox_not_found_by_name() {
    ...
    thrown.expectMessage("name='myCheckBox', type=javax.swing.JCheckBox, requireShowing=true");
  ...
  public void should_fail_if_visible_JCheckBox_not_found_by_type() {
    thrown.expect(ComponentLookupException.class);
    thrown.expectMessage("Unable to find component using matcher");
    thrown.expectMessage("type=javax.swing.JCheckBox, requireShowing=true");
    fixture.checkBox();
  }
