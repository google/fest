...
public class AbstractContainerFixture_toggleButton_Test extends RobotBasedTestCase {
  ...
  public void should_fail_if_visible_JToggleButton_not_found_by_name() {
    ...
    thrown.expectMessage("name='myButton', type=javax.swing.JToggleButton, requireShowing=true");
  ...
  public void should_fail_if_visible_JToggleButton_not_found_by_type() {
    thrown.expect(ComponentLookupException.class);
    thrown.expectMessage("Unable to find component using matcher");
    thrown.expectMessage("type=javax.swing.JToggleButton, requireShowing=true");
